...
record('prismaAcquireConnectionTimeout503', classifyApiErrorStatus(mk('P1004')) === 503);
...
record('pgQueryCanceled503', classifyApiErrorStatus(mk('57014')) === 503);
record('pgSerializationFailure503', classifyApiErrorStatus(mk('40001')) === 503);
record('pgLockNotAvailable503', classifyApiErrorStatus(mk('55P03')) === 503);
record('pgDeadlockDetected503', classifyApiErrorStatus(mk('40P01')) === 503);
...
record('nonListedSqlStateStays400', classifyApiErrorStatus(mk('22001')) === 400);
